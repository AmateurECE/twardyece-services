 ...
 * build. In a single project build this file can be empty or even removed.
 *
 * Detailed information about configuring a multi-project build in Gradle can
 * be found in the user guide at:
 * https://docs.gradle.org/4.4.1/userguide/multi_project_builds.html
 */
